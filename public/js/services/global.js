  ...
  .factory('MakeAWishFactsService', [function() {
    return {
      getMakeAWishFacts: function() {
        let facts = ['Health professionals who treat wish kids, including nurses and doctors, overwhelmingly believe that the wish experience can improve a wish kids’ physical health.',
